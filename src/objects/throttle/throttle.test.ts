...
describe('throttle', () => {
  ...
  describe('flush method', () => {
    ...
    it('should return the result when flushing', () => {
      const testFn = vi.fn().mockReturnValue('flushed result');
      const throttled = throttle(testFn, 100);
  ...
  describe('edge cases', () => {
    ...
    it('should handle function with no arguments', () => {
      const noArgFn = vi.fn().mockReturnValue('no args');
  ...
  describe('timer management', () => {
    it('should properly manage timers', () => {
      ...
      throttled('test2');
      expect(vi.getTimerCount()).toBe(1); // Should reuse timer
  ...
  describe('context binding', () => {
    it('should preserve function context', () => {
      ...
      const contextFn = vi.fn(function(this: typeof context) {
        return this.value;
      });
